...
<body>
	...
	try{
		...
		String string_topspeed = request.getParameter("megapixels");
		String string_width = request.getParameter("ram");
		String string_mobile_type = request.getParameter("mobile_type");
		...
		int int_megapixel = Integer.parseInt(string_topspeed);
 		int int_ram = Integer.parseInt(string_width);
		...
		String insert_in_plane = "INSERT INTO mobile(name, megapixels, ram, mobile_type, itemID) VALUES(?,?,?,?,?)" ;
		ps = con.prepareStatement(insert_in_plane);
		ps.setString(1, itemName);
		ps.setInt(2, int_megapixel);
		ps.setInt(3, int_ram);
		ps.setString(4, string_mobile_type);
